...
void auto_prepare_run( Int_t run )
{
  ...
  //  
  TString strTempPath = TString( strAcquPath + "/data/He3_AUTO_temp" );
  sprintf( szDir, 
	   "%s/data/AUTO/AUTO_%i",
  	   strAcquPath.Data(),
  	   run );
  ...
  //
  ic.CopyARconfig( run, 
		   "/usr/users/witth/AcquRoot/acqu/acqu/data/He3_AUTO_temp/CB.Offline", 
		   "/usr/users/witth/AcquRoot/acqu/acqu/data/AUTO/XXXX/CB.Offline" );
    
  // change CBanalys.dat
  //
  ic.CopyARconfig( run, 
		   "/usr/users/witth/AcquRoot/acqu/acqu/data/He3_AUTO_temp/CBanalysis.dat", 
		   "/usr/users/witth/AcquRoot/acqu/acqu/data/AUTO/XXXX/CBanalysis.dat" );

  // change Tagger/Tagger.dat
  //
  ic.CopyARconfig( run, 
		   "/usr/users/witth/AcquRoot/acqu/acqu/data/He3_AUTO_temp/Tagger/Tagger.dat", 
		   "/usr/users/witth/AcquRoot/acqu/acqu/data/AUTO/XXXX/Tagger/Tagger.dat" );

  // change CB/CB_PID.dat
  //
  ic.CopyARconfig( run, 
		   "/usr/users/witth/AcquRoot/acqu/acqu/data/He3_AUTO_temp/CB/CB_PID.dat", 
		   "/usr/users/witth/AcquRoot/acqu/acqu/data/AUTO/XXXX/CB/CB_PID.dat" );

  // change TAPS/TAPS.dat
  //
  ic.CopyARconfig( run, 
		   "/usr/users/witth/AcquRoot/acqu/acqu/data/He3_AUTO_temp/TAPS/TAPS.dat", 
		   "/usr/users/witth/AcquRoot/acqu/acqu/data/AUTO/XXXX/TAPS/TAPS.dat" );

  // prepare CBServer.dat file
  //
  ic.CopyARconfig( run, 
		   "/usr/users/witth/AcquRoot/acqu/acqu/data/He3_AUTO_temp/CBServer.Offline", 
