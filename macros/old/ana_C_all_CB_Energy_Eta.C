...
TCanvas *cGrap = new TCanvas("cGrap", "Projection histo", 0, 500, 800, 500);
...
void GetPi0Mass(Char_t* szFile, Double_t *val)
{
  ...
  if( file0 )
    {   
      ...
      Double_t min =  peack - 50.;
      Double_t max =  peack + 50.;
      
      
      TF1 *f1 = new TF1( "f1", "pol1+gaus(2)", min, max );
      f1->SetParameters( 1., 1., 100, peack, 10);
      ...
      hpx->SetTitle(szFile);
      hpx->GetXaxis()->SetRangeUser(450, 650);
