...
TH1F *hGr = new TH1F("hGr", ";Run/Date;IM_{#pi^{0}}", 3620, 14431.5, 18051.5);
...
void GetPi0Mass(Char_t* szFile, Double_t *val)
{
  ...
  if( file0 )
    {   
      //      TH2F *h2d = (TH2F*) file0->Get("Calib.CB.2g.IM");
...
void ana_all_CB()
{
  ...
  hGr->GetXaxis()->SetRangeUser(14500, 14510);
  hGr->GetYaxis()->SetRangeUser(120, 150);
