...
void GetPi0Mass(Char_t* szFile, Double_t *val)
{
  ...
  if( file0 )
    {   
      TH2F *h2d = (TH2F*) file0->Get("CaLib_TAPS_IM_Neut");
...
//       Double_t max =  peack + 3.;
      ...
      f1->SetParameters( 1., 1., 100, 135, 6);
      ...
      hpx->SetTitle(szFile);
      //      hpx->GetXaxis()->SetRangeUser(-10, 10);
      hpx->GetXaxis()->SetRangeUser( 0, 400);
      hpx->Draw();
