...
void TCCalibPIDDroop::Init()
{
    ...
    // read old parameters
    TCMySQLManager::GetManager()->ReadParameters(fSet, kCALIB_PID_DROOP0, fPar0, fNelem);
    TCMySQLManager::GetManager()->ReadParameters(fSet, kCALIB_PID_DROOP1, fPar1, fNelem);
    TCMySQLManager::GetManager()->ReadParameters(fSet, kCALIB_PID_DROOP2, fPar2, fNelem);
    TCMySQLManager::GetManager()->ReadParameters(fSet, kCALIB_PID_DROOP3, fPar3, fNelem);
...
void TCCalibPIDDroop::Write()
{
    ...
    TCMySQLManager::GetManager()->WriteParameters(fSet, kCALIB_PID_DROOP0, fPar0, fNelem);
    TCMySQLManager::GetManager()->WriteParameters(fSet, kCALIB_PID_DROOP1, fPar1, fNelem);
    TCMySQLManager::GetManager()->WriteParameters(fSet, kCALIB_PID_DROOP2, fPar2, fNelem);
    TCMySQLManager::GetManager()->WriteParameters(fSet, kCALIB_PID_DROOP3, fPar3, fNelem);
}
