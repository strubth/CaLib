...
void TCCalibCBQuadEnergy::Init()
{
    ...
    // read old parameters
    TCMySQLManager::GetManager()->ReadParameters(fSet, kCALIB_CB_EQUAD0, fPar0, fNelem);
    TCMySQLManager::GetManager()->ReadParameters(fSet, kCALIB_CB_EQUAD1, fPar1, fNelem);
    ...
    Double_t lowPi0 = TCReadConfig::GetReader()->GetConfigDouble("CB.Energy.Histo.Overview.Pi0.Yaxis.Min");
    Double_t uppPi0 = TCReadConfig::GetReader()->GetConfigDouble("CB.Energy.Histo.Overview.Pi0.Yaxis.Max");
    Double_t lowEta = TCReadConfig::GetReader()->GetConfigDouble("CB.Energy.Histo.Overview.Eta.Yaxis.Min");
    Double_t uppEta = TCReadConfig::GetReader()->GetConfigDouble("CB.Energy.Histo.Overview.Eta.Yaxis.Max");
...
void TCCalibCBQuadEnergy::Write()
{
    ...
    TCMySQLManager::GetManager()->WriteParameters(fSet, kCALIB_CB_EQUAD0, fPar0, fNelem);
    TCMySQLManager::GetManager()->WriteParameters(fSet, kCALIB_CB_EQUAD1, fPar1, fNelem);
}
