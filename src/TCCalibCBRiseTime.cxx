...
#include "TCCalibCBRiseTime.h"

ClassImp(TCCalibCBRiseTime)


//______________________________________________________________________________
TCCalibCBRiseTime::TCCalibCBRiseTime()
    : TCCalib("CB.RiseTime", "CB rise time calibration", kCALIB_CB_WALK0, TCConfig::kMaxCB)
{
    // Empty constructor.
...
void TCCalibCBRiseTime::Init()
{
    ...
    // get histogram name
    if (!TCReadConfig::GetReader()->GetConfig("CB.RiseTime.Histo.Fit.Name"))
    {
    ...
    TCUtils::FormatHistogram(fMainHisto, "CB.RiseTime.Histo.Fit");
    fMainHisto->Draw("colz");

    // draw the overview histogram
    fCanvasResult->cd();
    TCUtils::FormatHistogram(fOverviewHisto, "CB.RiseTime.Histo.Overview");
    fOverviewHisto->Draw("P");
}

//______________________________________________________________________________
void TCCalibCBRiseTime::Fit(Int_t elem)
{
    ...
    fCanvasFit->cd(2);
    TCUtils::FormatHistogram(fFitHisto, "CB.RiseTime.Histo.Fit");
    fFitHisto->Draw("hist");
...
//______________________________________________________________________________
void TCCalibCBRiseTime::Calculate(Int_t elem)
{
    ...
    printf("Element: %03d    Peak: %12.8f    "
           "old rise time: %12.8f    new rise time: %12.8f",
